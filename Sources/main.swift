...
final class AppDelegate: NSObject, NSApplicationDelegate, WKScriptMessageHandler, WKNavigationDelegate {
    ...
    func applicationDidFinishLaunching(_ note: Notification) {
        ...
        // сайт остаётся под флагом `--web`. Функции, ради которых флаг завели
        // изначально, нативный слой с 02.09.2026 умеет сам; флаг живёт ради
        // моделей, кроме B170, и страниц, которых у нас пока нет вовсе, —
        // проверка посадки, супермикрофон, рация, цвет кейса и прочее.
